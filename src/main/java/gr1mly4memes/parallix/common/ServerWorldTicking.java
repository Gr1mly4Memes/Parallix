...
import gr1mly4memes.parallix.common.mixin_support.interfaces.ServerWorldExtended;
import gr1mly4memes.parallix.common.thread.ThreadHelper;
import gr1mly4memes.parallix.common.thread.ThreadLocals;
...
public class ServerWorldTicking {
     ...
     * Returns a collection of entities that should be ticked again before the end of the tick. See {@link gr1mly4memes.parallix.init.ModGameRules#TELEPORTED_ENTITY_ADDITIONAL_TICK}
     */
