...
/**
 * LegacyRandomSource mixin for thread-safe random number generation during parallel entity ticking.
 * Based on Async's ThreadSafeLegacyRandomSourceMixin - uses AtomicLong for seed to prevent race conditions.
 */
